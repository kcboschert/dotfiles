...
Use this reference when deciding whether a session learning belongs in `AGENTS.md` and where it
should be placed.

## Routing Decision

Use `update-pi-learnings` when the learning is about:

- Pi-coding-agent workflow behavior in this project
- session-management behavior for the main Pi conversation
- scope-control behavior for the main Pi conversation
- project-specific Pi habits that should persist across future sessions
...
| Project-specific Pi behavior that does not fit the structured workflow buckets | `## Behavioral Patterns` |
...
- the update rewrites large sections of `AGENTS.md` just to add one rule
